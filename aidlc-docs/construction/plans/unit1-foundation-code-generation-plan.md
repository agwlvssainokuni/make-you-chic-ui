...
- [ ] **Step 1: プロジェクト構造セットアップ(Greenfield初回)**
...
- [ ] **Step 3: テーマ状態管理ロジック生成(Business Logic)**
...
- [ ] **Step 7: Icon コンポーネント生成(Frontend Components)**
...
- [ ] **Step 11: HTML版デモへの反映(FR6、Question 2=A方針)**
